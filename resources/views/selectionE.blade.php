                                ...
                                <div class="card-body text-center pt-4">
                                    ...
                                    <div class="mt-7">
                                        <div class="symbol-label" style="overflow: hidden; justify-content: center; align-items: center;">
                                            <img src="{{'http://localhost/RehabilitacionApp/public'.$ex->therapy_image}}" alt="" style="width: 100%; height: auto;" class="rounded">
                                        </div>
                                    </div>
                                    <!--end::User-->
                                    <!--begin::Name-->
                                    <div class="my-2">
                                        <span class="text-dark font-weight-bold font-size-h4">{{$ex->exercise_name}}</span>
                                    </div>
                                    <form action="{{action('ExerciseController@exercise', $ex->exercise_id)}}">
                                        {{ csrf_field() }}
